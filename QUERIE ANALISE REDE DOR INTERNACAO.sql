--RECRIA AS TABELAS DE INTERNAÇÃO DO GT SINISTRO QUE SERÃO USADAS PARA CRIAR A BASE DE INTERNACAO-
----------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TABLE `self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_CIRURGICA_ANALITICA_LA`
...
SELECT SIN.NUM_INTERNACAO
      ...
      ,CASE WHEN BENEF.DSC_CARTEIRA = 'ADMINISTRADO'
        ...
        END AS DSC_CARTEIRA
      ,CASE WHEN BENEF.NME_PLANO IN ('EXATO','EXATO 20','MASTER','GM','MEGA I','EXATO GROB','EXATO MBB','EXATO APT','EXATO APTO','MEGA II','VITA','RDB EXATO','LG EXATO') 
            THEN 'EXATO'
            WHEN BENEF.NME_PLANO IN ('BASICO','ESTILO I','FIT','ALPHA','MAXI 100','ODONTOLOGICO','ESTILO  I','BASICO 10','COMPACTO','BASICO 20','ODONTO MAIS','BASICO 20 II EMS','BÁSICO 20','BASICO APT','BASICO 10 APT','CLASSICO','CLASSICO 20','ODONTO DOC','CLASSICO ENF.','CLASSICO ENF','CLÁSSICO 20','MASTER I','OSWALDOCRUZ100','FUNC SP I','GB CLASSICO','CLASSICO APTO.','CLASSICO APTO','MASTER II','FUNC SP II','RDB CLASSICO','SELECT') 
            THEN 'BASICO+CLASSICO'
            WHEN BENEF.NME_PLANO IN ('ESPECIAL','ESPECIAL 20','ESTILO II','PRATA','DIAMANTE','BETA','MAXI 200','ESPECIAL 100','ESPECIAL 30','ESPECIAL 100 R1','ESPECIAL 500','MASTER III','MASTER IV','VITA PRO','OSWALDOCRUZ200','GM SUPERIOR','FUNC SP PLUS','MEGA R III','GB ESPECIAL','RDB ESPECIAL','LG ESPECIAL') 
            THEN 'ESPECIAL'
            WHEN BENEF.NME_PLANO IN ('EXECUTIVO','MAXI 300','OMEGA','PLATINUM','EXECUTIVO 20','EXECUTIVO 20 II - 3X','EXECUTIVO 20 II - 4X','EXECUTIVO 30','EXECUTIVO R1','EXECUTIVO R2','MASTER V','VITA PLUS','OSWALDOCRUZ300','MEGA R IV','GB EXECUTIVO','RDB EXECUTIVO','MAXIMO','MAXIMUM','MAXI 400','PRESTIGE','PRESTIGE 20','PRESTIGE PME','GB PRESTIGE','RDB PRESTIGE') 
            THEN 'EXECUTIVO+PRESTIGE'
            WHEN BENEF.NME_PLANO IN ('DIRETO RIO','DIRETO SAMPA BRANCO','DIRETO ABC','DIRETO CURITIBA','DIRETO CAMPINAS','DIRETO RECIFE AZUL','DIRETO SAMPA AZUL',
            ...
            THEN 'DIRETOS'
    /* DEMAIS */ 
            WHEN BENEF.NME_PLANO IN ('VITAL', 'VITAL APT','EXTRA', 'EXTRA APT', 'EXTRA PRO', 'EXTRA PLUS', 'EXP FUNC DOR','IDEAL') 
            THEN 'DEMAIS'
            ELSE 'NAO CADASTRADO' 
        END AS NME_PLANO
...
CREATE OR REPLACE TABLE `self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_CLINICA_ANALITICA_LA`
-- OPTIONS (
...
CREATE OR REPLACE TABLE `self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_DOMICILIAR_ANALITICA_LA`
-- OPTIONS (
--     EXPIRATION_TIMESTAMP=TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
-- )
AS
...
CREATE OR REPLACE TABLE `self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_PARTO_ANALITICA_LA`
-- OPTIONS (
--     EXPIRATION_TIMESTAMP=TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
-- )
AS
...
CREATE OR REPLACE TABLE `self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_PSIQUIATRICA_ANALITICA_LA`
-- OPTIONS (
--     EXPIRATION_TIMESTAMP=TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
-- )
AS
...
CREATE OR REPLACE TABLE SANDBOX_GERAC.LT_GT_SINISTRO_BASE_TOTAL_INTERNACOES2 AS 
WITH BENEFS AS (
  SELECT DISTINCT 
    COD_ANALITICO_BENEFICIARIO
    , COD_PRODUTO
    , CASE 
      ...
      WHEN IDC_TIPO_PLANO IN 
        (  
           'BASICO','ESTILO I','FIT','ALPHA','MAXI 100','ODONTOLOGICO','ESTILO  I','BASICO 10','COMPACTO','BASICO 20','ODONTO MAIS','BASICO 20 II EMS','BÃSICO 20','BASICO APT','BASICO 10 APT','CLASSICO','CLASSICO 20','ODONTO DOC'
          ,'CLASSICO ENF.','CLASSICO ENF','CLÃSSICO 20','MASTER I','OSWALDOCRUZ100','FUNC SP I','GB CLASSICO','CLASSICO APTO.','CLASSICO APTO','MASTER II','FUNC SP II','RDB CLASSICO','SELECT'
        ) 
        THEN 'BASICO+CLASSICO'
      WHEN IDC_TIPO_PLANO IN 
        (
      ...
      (
        ...
        'DIRETO BRASILIA','DIRETO JOAO PESSOA','DIRETO JOINVILLE','DIRETO BELO HORIZONTE','DIRETO RIO AZUL MARIN','DIRETO RIO AZUL ROYAL',
        'DIRETO SAMPA LARANJA','DIRETO RIO PRETO','DIRETO RIBEIRÃƒO PRETO','DIRETO SALVADOR','DIRETO UBERLANDIA','DIRETO MAIS'
      ) 
        THEN 'DIRETOS'
      -- DEMAIS
...
SELECT
  ...
  , COD_ANALITICO_BENEFICIARIO
  , BENEFS.COD_PRODUTO
  , BENEFS.NME_PLANO_AJUSTADO_ATUARIAL
  , NME_PLANO
  , DSC_CARTEIRA
  , FLG_ORIGEM_PS
  , FLG_COVID
...
FROM self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_CIRURGICA_ANALITICA_LA
LEFT JOIN BENEFS
  USING(COD_ANALITICO_BENEFICIARIO)
...
FROM self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_CLINICA_ANALITICA_LA
LEFT JOIN BENEFS
  USING(COD_ANALITICO_BENEFICIARIO)
LEFT JOIN self-service-saude-prd.REF_SAUDE_PRESTADOR_REFERENCIADO.TB_CAD_PRESTADOR_REFERENCIADO P 
  USING(COD_PRESTADOR)
...
FROM self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_DOMICILIAR_ANALITICA_LA
LEFT JOIN BENEFS
  USING(COD_ANALITICO_BENEFICIARIO)
LEFT JOIN self-service-saude-prd.REF_SAUDE_PRESTADOR_REFERENCIADO.TB_CAD_PRESTADOR_REFERENCIADO P 
  USING(COD_PRESTADOR)
...
FROM self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_PARTO_ANALITICA_LA
LEFT JOIN BENEFS
  USING(COD_ANALITICO_BENEFICIARIO)
LEFT JOIN self-service-saude-prd.REF_SAUDE_PRESTADOR_REFERENCIADO.TB_CAD_PRESTADOR_REFERENCIADO P 
  USING(COD_PRESTADOR)
...
FROM self-service-saude.SANDBOX_GERAC.TB_GT_SINISTRO_COMPETENCIA_PSIQUIATRICA_ANALITICA_LA
LEFT JOIN BENEFS
  USING(COD_ANALITICO_BENEFICIARIO)
LEFT JOIN self-service-saude-prd.REF_SAUDE_PRESTADOR_REFERENCIADO.TB_CAD_PRESTADOR_REFERENCIADO P 
  USING(COD_PRESTADOR)
...
CREATE OR REPLACE TABLE SANDBOX_GERAC.LT_GT_SINISTRO_BASE_TOTAL_INTERNACOES_ANALISE_DOR_DATASTUDIO AS
...
FROM SANDBOX_GERAC.LT_GT_SINISTRO_BASE_TOTAL_INTERNACOES2
WHERE COD_PRODUTO NOT IN (882, 
883, 
885, 
886, 
887, 
...
AND NME_PLANO NOT IN ('250 SENIOR I', 
'252 SENIOR I', 
'245 PLENO II', 
'244 PLENO I',
'175 BASICO', 
...
CAST(SGL_UF_PRESTADOR AS STRING) as SIG_UF_PRESTADOR,
CAST(ANO AS STRING) as ANO,
CAST(MES AS STRING) AS MES,
CAST(ANO_MES AS STRING) AS ANO_MES,
CAST(BASE AS STRING) AS BASE,
CAST(DSC_CARTEIRA AS STRING) AS DSC_CARTEIRA,
CAST(NME_PLANO_AJUSTADO_ATUARIAL AS STRING) AS NME_PLANO_AJUSTADO_ATUARIAL,
CAST(FLG_ORIGEM_PS AS STRING) AS FLG_ORIGEM_PS,
CAST(FLG_COVID AS STRING) AS FLG_COVID,
CAST(FLG_DIARIA_UTI_GERAL AS STRING) AS FLG_DIARIA_UTI_GERAL,
CAST(FLG_DIARIA_PARTO_UTI_NEONATAL AS STRING) AS FLG_DIARIA_PARTO_UTI_NEONATAL,
CAST(FLG_DIARIA_PARTO_UTI_ADULTO AS STRING) AS FLG_DIARIA_PARTO_UTI_ADULTO,
CAST(FLG_DIARIA_PARTO_UTI_GERAL AS STRING) AS FLG_DIARIA_PARTO_UTI_GERAL,
...
CAST(TOTAL_DIAS_INTERNADO_2018 AS INTEGER) AS TOTAL_DIAS_INTERNADO_2018,
CAST(TOTAL_DIAS_INTERNADO_2019 AS INTEGER) AS TOTAL_DIAS_INTERNADO_2019,
CAST(TOTAL_DIAS_INTERNADO_2020 AS INTEGER) AS TOTAL_DIAS_INTERNADO_2020,
CAST(TOTAL_DIAS_INTERNADO_2021 AS INTEGER) AS TOTAL_DIAS_INTERNADO_2021,
CAST(TOTAL_DIAS_INTERNADO_2022 AS INTEGER) AS TOTAL_DIAS_INTERNADO_2022,
CAST(TOTAL_CUSTO_HM_2018 AS NUMERIC) AS TOTAL_CUSTO_HM_2018,
CAST(TOTAL_CUSTO_HM_2019 AS NUMERIC) AS TOTAL_CUSTO_HM_2019,
CAST(TOTAL_CUSTO_HM_2020 AS NUMERIC) AS TOTAL_CUSTO_HM_2020,
CAST(TOTAL_CUSTO_HM_2021 AS NUMERIC) AS TOTAL_CUSTO_HM_2021,
CAST(TOTAL_CUSTO_HM_2022 AS NUMERIC) AS TOTAL_CUSTO_HM_2022,
CAST(TOTAL_CUSTO_HOSPITALAR_2018 AS NUMERIC) AS TOTAL_CUSTO_HOSPITALAR_2018,
CAST(TOTAL_CUSTO_HOSPITALAR_2019 AS NUMERIC) AS TOTAL_CUSTO_HOSPITALAR_2019,
CAST(TOTAL_CUSTO_HOSPITALAR_2020 AS NUMERIC) AS TOTAL_CUSTO_HOSPITALAR_2020,
CAST(TOTAL_CUSTO_HOSPITALAR_2021 AS NUMERIC) AS TOTAL_CUSTO_HOSPITALAR_2021,
CAST(TOTAL_CUSTO_HOSPITALAR_2022 AS NUMERIC) AS TOTAL_CUSTO_HOSPITALAR_2022,
CAST(TOTAL_CUSTO_MATERIAL_2018 AS NUMERIC) AS TOTAL_CUSTO_MATERIAL_2018,
CAST(TOTAL_CUSTO_MATERIAL_2019 AS NUMERIC) AS TOTAL_CUSTO_MATERIAL_2019,
CAST(TOTAL_CUSTO_MATERIAL_2020 AS NUMERIC) AS TOTAL_CUSTO_MATERIAL_2020,
CAST(TOTAL_CUSTO_MATERIAL_2021 AS NUMERIC) AS TOTAL_CUSTO_MATERIAL_2021,
CAST(TOTAL_CUSTO_MATERIAL_2022 AS NUMERIC) AS TOTAL_CUSTO_MATERIAL_2022,
CAST(TOTAL_CUSTO_MEDICAMENTOS_2018 AS NUMERIC) AS TOTAL_CUSTO_MEDICAMENTOS_2018,
CAST(TOTAL_CUSTO_MEDICAMENTOS_2019 AS NUMERIC) AS TOTAL_CUSTO_MEDICAMENTOS_2019,
CAST(TOTAL_CUSTO_MEDICAMENTOS_2020 AS NUMERIC) AS TOTAL_CUSTO_MEDICAMENTOS_2020,
CAST(TOTAL_CUSTO_MEDICAMENTOS_2021 AS NUMERIC) AS TOTAL_CUSTO_MEDICAMENTOS_2021,
CAST(TOTAL_CUSTO_MEDICAMENTOS_2022 AS NUMERIC) AS TOTAL_CUSTO_MEDICAMENTOS_2022,
...
CAST(SINISTRADOS_2018 AS INTEGER) AS SINISTRADOS_2018,
CAST(SINISTRADOS_2019 AS INTEGER) AS SINISTRADOS_2019,
CAST(SINISTRADOS_2020 AS INTEGER) AS SINISTRADOS_2020,
CAST(SINISTRADOS_2021 AS INTEGER) AS SINISTRADOS_2021,
CAST(SINISTRADOS_2022 AS INTEGER) AS SINISTRADOS_2022,
...
CAST(VAR_ABS_TOTAL_DIAS_INTERNADO_19_18 AS INTEGER) AS VAR_ABS_TOTAL_DIAS_INTERNADO_19_18,
CAST(VAR_ABS_TOTAL_DIAS_INTERNADO_20_19 AS INTEGER) AS VAR_ABS_TOTAL_DIAS_INTERNADO_20_19,
CAST(VAR_ABS_TOTAL_DIAS_INTERNADO_21_20 AS INTEGER) AS VAR_ABS_TOTAL_DIAS_INTERNADO_21_20,
CAST(VAR_ABS_TOTAL_DIAS_INTERNADO_22_21 AS INTEGER) AS VAR_ABS_TOTAL_DIAS_INTERNADO_22_21,
CAST(VAR_ABS_TOTAL_DIAS_INTERNADO_22_19 AS INTEGER) AS VAR_ABS_TOTAL_DIAS_INTERNADO_22_19,
CAST(VAR_ABS_TOTAL_CUSTO_HM_19_18 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HM_19_18,
CAST(VAR_ABS_TOTAL_CUSTO_HM_20_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HM_20_19,
CAST(VAR_ABS_TOTAL_CUSTO_HM_21_20 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HM_21_20,
CAST(VAR_ABS_TOTAL_CUSTO_HM_22_21 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HM_22_21,
CAST(VAR_ABS_TOTAL_CUSTO_HM_22_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HM_22_19,
CAST(VAR_ABS_TOTAL_CUSTO_HOSPITALAR_19_18 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HOSPITALAR_19_18,
CAST(VAR_ABS_TOTAL_CUSTO_HOSPITALAR_20_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HOSPITALAR_20_19,
CAST(VAR_ABS_TOTAL_CUSTO_HOSPITALAR_21_20 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HOSPITALAR_21_20,
CAST(VAR_ABS_TOTAL_CUSTO_HOSPITALAR_22_21 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HOSPITALAR_22_21,
CAST(VAR_ABS_TOTAL_CUSTO_HOSPITALAR_22_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_HOSPITALAR_22_19,
CAST(VAR_ABS_TOTAL_CUSTO_MATERIAL_19_18 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MATERIAL_19_18,
CAST(VAR_ABS_TOTAL_CUSTO_MATERIAL_20_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MATERIAL_20_19,
CAST(VAR_ABS_TOTAL_CUSTO_MATERIAL_21_20 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MATERIAL_21_20,
CAST(VAR_ABS_TOTAL_CUSTO_MATERIAL_22_21 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MATERIAL_22_21,
CAST(VAR_ABS_TOTAL_CUSTO_MATERIAL_22_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MATERIAL_22_19,
CAST(VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_19_18 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_19_18,
CAST(VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_20_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_20_19,
CAST(VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_21_20 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_21_20,
CAST(VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_22_21 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_22_21,
CAST(VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_22_19 AS NUMERIC) AS VAR_ABS_TOTAL_CUSTO_MEDICAMENTOS_22_19,
...
CAST(VAR_ABS_SINISTRADOS_19_18 AS INTEGER) AS VAR_ABS_SINISTRADOS_19_18,
CAST(VAR_ABS_SINISTRADOS_20_19 AS INTEGER) AS VAR_ABS_SINISTRADOS_20_19,
CAST(VAR_ABS_SINISTRADOS_21_20 AS INTEGER) AS VAR_ABS_SINISTRADOS_21_20,
CAST(VAR_ABS_SINISTRADOS_22_21 AS INTEGER) AS VAR_ABS_SINISTRADOS_22_21,
CAST(VAR_ABS_SINISTRADOS_22_19 AS INTEGER) AS VAR_ABS_SINISTRADOS_22_19
FROM `self-service-saude.SANDBOX_GERAC.EXCEL_TEMPORARIO_INT`
...
FROM `self-service-saude.SANDBOX_GERAC.LT_GT_SINISTRO_BASE_TOTAL_INTERNACOES_ANALISE_DOR_DATASTUDIO`
